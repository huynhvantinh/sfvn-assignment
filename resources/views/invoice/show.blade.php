            ...
            <div class="col-md-12">
                <div class="tile">
                    <section class="invoice">
                        <div class="row mb-4">
                            <div class="col-6">
                                <h2 class="page-header"><i class="fa fa-file"></i> Invoice #{{1000+$invoice->id}}</h2>
                            </div>
                            <div class="col-6">
                        ...
                        <div class="row invoice-info">
                            ...
                            {{-- <div class="col-4"><strong>{{$invoice->customer->name}}</strong></div> --}}
                            <div class="col-4"><strong>{{$invoice->customer_name}}</strong></div>
                        </div>
                        <div class="row">
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    @foreach($sales as $stt_sale => $sale)
                                    <tr>
                                        <td>{{$stt_sale + 1}}</td>
