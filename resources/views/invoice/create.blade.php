                    ...
                    <div class="tile-body">
                        <form  method="POST" action="{{route('invoice.store')}}">
                            ...
                            <div class="form-group col-md-3">
                                <label class="control-label">Saved Customer</label>
                                <select name="customer_id" class="form-control saved-customer">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="customer_name" class="form-control customer-name" required>
                            </div>
...
@push('js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            // $('tbody').delegate('.savedcustomer', 'change', function () {
            //     console.log("Changed1");
            // })
            $('.saved-customer').on( 'change',function () {
                console.log("Changed1");
                $('.customer-name').val($(this).find(":selected").text().trim());
            })
            ...
            $('tbody').delegate('.productname', 'change', function () {
                ...
                $.ajax({
                    ...
                    success:function (data) {
                        ...
                        console.log("PRICE: ", data.sales_price);
                    }
                });
            });
