...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        {{-- <li><a class="app-menu__item {{ request()->is('sales') ? 'active' : ''}}" href="{{ route('sales.index') }}"><i class="app-menu__icon fa fa-dollar"></i><span class="app-menu__label">View Sales</span></a></li> --}}
